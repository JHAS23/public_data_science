...
# if there no critical errors in work area views for all modules call R Main and execute all modules
  ...
  echo " Call R Main module monthly run"  >> $LOG_FILE


  /app/r/R-3.0.2/bin/Rscript main.R MONTHLY_RUN
...
# ELSE PART WILL BE EXECUTED IF THERE ARE CRITICAL ERRORS RELATED TO SOME MODULES BUT OTHERE MODULES HAVE NO CRITICAL ERRORS AND THEY CAN BE EXECUTED
