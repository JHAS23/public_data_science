...
# Remove rows where AE_COUNT=0 & AE_COUNT_EXPECTED <0.01 OR SAE_COUNT=0 & SAE_COUNT_EXPECTED <0.01
####################################################################################################
SA.out = SA.out[!(SA.out$AE_COUNT ==0 & SA.out$AE_COUNT_EXPECTED <0.01),]
SA.out = SA.out[!(SA.out$SAE_COUNT ==0 & SA.out$SAE_COUNT_EXPECTED <0.01),]
######## End of modification ###########################
####################################################################################################
...
Model.data.SA = Model.data.SA[,!names(Model.data.SA)%in% "STUDY_THERAPEUTIC_AREA3"]
######## End of modification ###########################
