...
#######################################################################################################################################################################################
###### New Addition -- Adding a new therapeutic area in important.TA and creating a new variable STUDY_THERAPEUTIC_AREA3  ##############################################
########################################################################################################################################################################################

 important.TA3 <- c("METABOLIC DISEASE", "NEUROSCIENCE (NEUROLOGY)",
                    "NEUROSCIENCE (PSYCHIATRY)", "ONCOLOGY", "PAIN",
                    "CARDIOVASCULAR", "VACCINES", "INFLAMMATION")

  # Now substtuting the non-important TA's with 'OTHER' and ensuring it is a factor
  TA.char <- as.character(Study.vars$STUDY_THERAPEUTIC_AREA)
  Study.vars$STUDY_THERAPEUTIC_AREA3 <- ifelse(TA.char %in% important.TA3,
                                               TA.char, "OTHER")
  Study.vars$STUDY_THERAPEUTIC_AREA3 <- factor(Study.vars$STUDY_THERAPEUTIC_AREA3,
                                               levels=c(important.TA3, "OTHER"))
